...
import org.eluder.testutils.core.TestRunnerTest.FirstLifeCycle;
import org.eluder.testutils.core.TestRunnerTest.SecondLifeCycle;
import org.eluder.testutils.core.test.BaseLifeCycle;
...
public class TestRunnerTest {
    ...
    public static abstract class AbstractLifeCycle extends BaseLifeCycle {
        ...
        private void assertBasic(final TestClass testClass, final FrameworkMethod method, final Object target) {
            Assert.assertEquals("org.eluder.testutils.core.TestRunnerTest", testClass.getName());
